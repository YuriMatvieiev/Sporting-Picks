(() => {
    ...
    let liveSliderInstance = null;
    function initSliders() {
        if (document.querySelector(".today-best__slider")) new swiper_core_Swiper(".today-best__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            speed: 800,
            navigation: {
                prevEl: ".today-best__prev",
                nextEl: ".today-best__next"
            },
            breakpoints: {
                375: {
                    slidesPerView: 1,
    ...
    function handleLiveSlider() {
        const sliderSelector = ".live__slider";
        const breakpoint = 767.98;
        const sliderEl = document.querySelector(sliderSelector);
        if (!sliderEl) return;
        if (window.innerWidth > breakpoint) {
            if (!liveSliderInstance) liveSliderInstance = new swiper_core_Swiper(sliderSelector, {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
        ...
        } else if (liveSliderInstance) {
            liveSliderInstance.destroy(true, true);
            liveSliderInstance = null;
        }
    }
    window.addEventListener("DOMContentLoaded", handleLiveSlider);
    window.addEventListener("resize", handleLiveSlider);
